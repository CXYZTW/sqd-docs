...
### Archives[​](#archives "Direct link to Archives")
...
### `archive-registry`[​](#archive-registry "Direct link to archive-registry")
...
### Cloud (former Aquarium)[​](#cloud-former-aquarium "Direct link to Cloud (former Aquarium)")

A [cloud service](/cloud/) for deploying [squids](#squid) in a serverless fashion maintained by Subsquid Labs GmbH.

### Contracts pallet[​](#contracts-pallet "Direct link to Contracts pallet")
...
### Extrinsic[​](#extrinsic "Direct link to Extrinsic")
...
### FRAME pallets[​](#frame-pallets "Direct link to FRAME pallets")
...
### Frontier pallet[​](#frontier-pallet "Direct link to Frontier pallet")
...
### Hot blocks[​](#hot-blocks "Direct link to Hot blocks")
...
### OpenReader[​](#openreader "Direct link to OpenReader")
...
### Pallet[​](#pallet "Direct link to Pallet")
...
### Squid[​](#squid "Direct link to Squid")
...
### Squid processor[​](#squid-processor "Direct link to Squid processor")
...
### Squid API[​](#squid-api "Direct link to Squid API")
...
### Substrate Runtime[​](#substrate-runtime "Direct link to Substrate Runtime")
...
[Edit this page](https://github.com/subsquid/docs/edit/master/docs/glossary.md)

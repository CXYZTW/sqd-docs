---
title: "Overview"
description: "SQD Network is a distributed query engine and data lake that the SQD ecosystem is built around."
---
...
## Permissionless public network[​](#permissionless-public-network "Direct link to Permissionless public network")
...
## Open private network[​](#open-private-network "Direct link to Open private network")
...
```
const processor = new EvmBatchProcessor()  .setGateway('https://v2.archive.subsquid.io/network/ethereum-mainnet')
```
...
```
const processor = new SubstrateBatchProcessor()  .setGateway('https://v2.archive.subsquid.io/network/phala')
```

See [Substrate gateways](/subsquid-network/reference/networks/#substrate-based).

[Edit this page](https://github.com/subsquid/docs/edit/master/docs/subsquid-network/overview.mdx)

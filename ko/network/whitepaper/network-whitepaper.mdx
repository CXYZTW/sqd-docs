...
![image](/images/subsquid-network/whitepaper/8627422/279713390-8667b401-5213-4126-a0c2-55d39ba611e8.png)
...
![image](/images/subsquid-network/whitepaper/subsquid/subsquid-network-contracts/assets/8627422/beb1439d-aa15-42fa-8bc2-4fa89c7fc96d)

### Data Providers[​](#data-providers "Direct link to Data Providers")
...
![image](/images/subsquid-network/whitepaper/8627422/255241118-9ba68865-c088-42ac-a01b-f961d1ed564b.png)
...
![image](/images/subsquid-network/whitepaper/8627422/255990260-ee4eca18-faa0-4e14-a495-9aad99ef14cb.png)
...
### Logs collector[​](#logs-collector "Direct link to Logs collector")
...
### Reward Manager[​](#reward-manager "Direct link to Reward Manager")
...
### Data Consumers[​](#data-consumers "Direct link to Data Consumers")
...
### Boosters[​](#boosters "Direct link to Boosters")
...
![image](/images/subsquid-network/whitepaper/subsquid/subsquid-network-contracts/assets/8627422/a1ab5ce1-da58-4cdc-aac5-90728be23b9e)
...
![image](/images/subsquid-network/whitepaper/subsquid/subsquid-network-contracts/assets/8627422/8ae1eef9-95f3-4cc4-9b53-2dd8c02d9559)

## SQD Token[​](#sqd-token "Direct link to SQD Token")
...
```
enum DatasetState {  // submitted by the data provider   SUBMITTED,  // the data being distributed by the network  IN_PREPARATION,  // served by the network  ACTIVE,  // if the subscription fee  // has not been provided for the duration of an epoch  COOLDOWN,  // if the dataset is no longer served by the network  // and will be deleted  DISABLED}
```
...
## Appendix II -- Rewards[​](#appendix-ii----rewards "Direct link to Appendix II -- Rewards")
...
### Rewards pool[​](#rewards-pool "Direct link to Rewards pool")
...
### Reward rate[​](#reward-rate "Direct link to Reward rate")
...
![image](/images/subsquid-network/whitepaper/assets/8627422/39614ca9-332c-4825-8ef0-5dfb32ece1a2)
...
### Worker reward rate[​](#worker-reward-rate "Direct link to Worker reward rate")
...
```
s[i] = S[i]/sum(S[i])t_scanned[i] = T_scanned[i]/sum(T_scanned[i])t_e[i] = T_e[i]/sum(T_e[i])t[i] = sqrt(t_scanned[i] * t_e[i])
```
...
![image](/images/subsquid-network/whitepaper/8627422/257277215-5c902bb4-2a90-4847-8a1f-1cd88e46fb54.png)
...
![image](/images/subsquid-network/whitepaper/8627422/257228987-7863df56-8ad3-447d-a095-dae18c1027b3.png)

### Distribution between the worker and delegators[​](#distribution-between-the-worker-and-delegators "Direct link to Distribution between the worker and delegators")
...
[Edit this page](https://github.com/subsquid/docs/edit/master/docs/subsquid-network/whitepaper.md)

...
```
git clone https://github.com/subsquid-labs/tron-examplecd tron-examplenpm i
```

## TronBatchProcessor configuration[​](#tronbatchprocessor-configuration "Direct link to TronBatchProcessor configuration")
...
## Processing the data[​](#processing-the-data "Direct link to Processing the data")
...
[Edit this page](https://github.com/subsquid/docs/edit/master/docs/tron-indexing/indexing-usdt-transfers.mdx)

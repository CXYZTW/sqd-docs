---
title: "Fuel Mainnet"
description: "Data catalog and field definitions for Fuel Mainnet"
---
...
| `utxo_id` | string | UTXO ID |
| `owner` | string | Input owner |
| `amount` | integer | Input amount |
| `asset_id` | string | Asset ID |
| `tx_pointer` | object | Transaction pointer |
| `witness_index` | integer | Witness index |
| `maturity` | integer | Input maturity |
| `predicate` | string | Predicate code |
| `predicate_data` | string | Predicate data |

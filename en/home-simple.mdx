...
<div className="px-5 divide-y divide-gray-100 dark:divide-white/10">
   ...
   <Container>
    ...
    <CardGroup cols={3}>
        ...
        />
          ...
          description="Learn about the Subsquid decentralized data network"
          href="/network"
          icon="https://avatars.githubusercontent.com/u/108554348?s=280&v=4"
          category="Network"
          status="Coming Soon"
  ...
  <Container>
    <div className="flex flex-col w-full mb-8">
      ...
      <p
        className="text-[#5B616E] dark:text-gray-300 text-md mb-1 mt-3"
      >
        Explore the 250+ blockchain networks supported by Subsquid.
      </p>
    </div>
  ...
  <Columns cols={3}>
    <Card
      ...
      href="/sdk"
    >
    Complete guides and API references for building with Subsquid
    </Card>
    <Card

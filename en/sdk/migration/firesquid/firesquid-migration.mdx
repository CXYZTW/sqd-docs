---
title: "On the FireSquid release"
description: "Previous major release of SQD was called FireSquid. It featured GraphQL-based archives (, ) that were replaced by . Interfaces for data requests on the  side were changed without keeping backwards compatibility."
---
...
[Edit this page](https://github.com/subsquid/docs/edit/master/docs/firesquid.md)

---
title: "SQD Cloud deployments, now upgraded!"
---
...
![](/images/deployments-two-release-notes/user-attachments/assets/c32acb2f-51be-4047-b817-277eb8fe7eda)
...
![image](/images/deployments-two-release-notes/user-attachments/assets/35fbee5a-b6fb-49f8-805a-4d91a7820fab)
...
#### How do I get full access to the new features?[​](#how-do-i-get-full-access-to-the-new-features "Direct link to How do I get full access to the new features?")
...
#### Do I need to redeploy anything?[​](#do-i-need-to-redeploy-anything "Direct link to Do I need to redeploy anything?")
...
#### We really like versions, they work well for us, do we need to change our workflow?[​](#we-really-like-versions-they-work-well-for-us-do-we-need-to-change-our-workflow "Direct link to We really like versions, they work well for us, do we need to change our workflow?")
...
#### Do I need to use tags?[​](#do-i-need-to-use-tags "Direct link to Do I need to use tags?")
...
#### Why should I use tags? Convince me.[​](#why-should-i-use-tags-convince-me "Direct link to Why should I use tags? Convince me.")
...
#### Did any of my endpoints change on this release?[​](#did-any-of-my-endpoints-change-on-this-release "Direct link to Did any of my endpoints change on this release?")

No. Every endpoint remains unchanged.

#### Where can I learn more about these updates?[​](#where-can-i-learn-more-about-these-updates "Direct link to Where can I learn more about these updates?")
...
[Edit this page](https://github.com/subsquid/docs/edit/master/docs/deployments-two-release-notes.md)

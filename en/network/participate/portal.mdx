...
- Go to the [portals page](https://network.subsquid.io/portals) and press the "Lock" button.
  ![Lock button](/images/network/participate/portal_lock_button.png)
- Specify the amount of `SQD` you want to lock and the duration of the lockup.
  ![Lockup form](/images/network/participate/portal_lock_form.png)
...
![Lockup success](/images/network/participate/portal_lock_success.png)
...
![Auto extension switch](/images/network/participate/portal_auto_extension.png)

</Tip>

#### Step 2: Generate a peer ID

SQD Network is a decentralized peer-to-peer system. Portals are a type of peers participating in it. Like all peers, your portal requires a private key and a public unique identifier: the _peer ID_. Generate one of these with
...
⚠️ **Note:** Please make sure that the generated file is safe and secure at `<KEY_FILE_PATH>` (i.e. it will not be deleted accidentally and cannot be accessed by unauthorized parties). [Or else](#what-are-the-consequences-of-losing-my-key-file--getting-it-stolen).

#### Step 3: Register your portal

- Go to the [portals page](https://network.subsquid.io/portals) and click the "Add portal" button.
  ![Add portal button](/images/network/participate/portal_registration_button.png)
- Fill the portal registration form.
  ![Portal registration form](/images/network/participate/portal_registration_form.png)

  If you plan to make your portal public, click the "Publicly available" switch and populate the additional fields.
  ![Portal registration form - public](/images/network/participate/portal_registration_form_public.png)

  Once done, click "Confirm" and confirm the transaction in your wallet.

#### Step 4: Run your portal
...
![Lockup active](/images/network/participate/portal_lock_active.png)

...
Yes. If you delegate your SQD or register a worker, your tokens will be locked for a period of 50000 Ethereum blocks, starting at the end of the current [epoch](#what-is-an-epoch-in-the-context-of-sqd-network).
...
### What is "an epoch" in the context of SQD Network?
